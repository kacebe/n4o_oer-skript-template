...
toc-expand: false
toc-title: |
  ![Logo](/img/n4o_fair-oer-img.svg)
  Abschnitte
toc-location: right
number-sections: true # Auf false setzen, wenn keine Abschnittsnummerierung gewünscht
lightbox: true
...
:::{.callout-note appearance="minimal" icon="false" title="Über diese Seite"}
Vorlage für einen OER-Baustein, Materialart: Skript

[Repository]({{< meta repo-url >}})

[Website]({{< meta site-url >}})

Die Kommentare in den Dateien des Templates geben ausführliche Hinweise zum Anpassen der Vorlage.
:::
...
### Fundierte Kenntnisse {#sec-fundiert}

::: {.callout-note appearance="minimal" icon="false" title="Niveaustufe: Fundiert"}
Die weiteren Abschnitte sind Inhalte der Niveaustufe **"Fundiert"**:

<!-- Kurzangaben der Inhalte -->
:::

<!-- Abschnitte für fundierte Kenntnisse -->

#### Abschnitt-Überschrift

{{< lipsum 2 >}}

### Fortgeschrittene Kenntnisse {#sec-fortgeschritten}

::: {.callout-tip appearance="minimal" icon="false" title="Niveaustufe: Fortgeschritten"}
Die weiteren Abschnitte sind Inhalte der Niveaustufe **"Fortgeschritten"**:

<!-- Kurzangaben der Inhalte -->
:::

<!-- Abschnitte für fortgeschrittene Kenntnisse -->

#### Abschnitt-Überschrift

{{< lipsum 2 >}}

### Fachkundige Kenntnisse {#sec-fachkundig}

::: {.callout-caution appearance="minimal" icon="false" title="Niveaustufe: Fachkundig"}

Die weiteren Abschnitte enthalten Inhalte für die Niveaustufe **Fachkundig**:

<!-- Kurzangaben der Inhalte -->
:::

<!-- Abschnitte für fachkundige Kenntnisse -->
...
## Weiterführende Quellen und Informationen {.appendix}
...
<!-- Verweise auf Website und Repository werden in _oer_metadata.yml global festgelegt -->
